package md5c6d2a1909cbb2f516dbaeb2595cd0be5;


public class LogActivity_MyWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VSTS.LogActivity+MyWebViewClient, VSTS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LogActivity_MyWebViewClient.class, __md_methods);
	}


	public LogActivity_MyWebViewClient ()
	{
		super ();
		if (getClass () == LogActivity_MyWebViewClient.class)
			mono.android.TypeManager.Activate ("VSTS.LogActivity+MyWebViewClient, VSTS, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
